...
#define USB_DEVICE_CONTROLLER_ID kUSB_ControllerKhci0
...
#define USB_DEVICE_CLASS_INTERFACE_COUNT (1)

/*!
 * @brief Structure containing device handle, hadle of interfaces and information on current configuration, alternate setting, speed and attachment status.
 *
 */
