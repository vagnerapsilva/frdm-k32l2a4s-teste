...
extern char ssd1306_WriteString(const char* str, FontDef Font, SSD1306_COLOR color);
...
extern void ssd1306_DrawArcWithRadiusLine(uint8_t x, uint8_t y, uint8_t radius, uint16_t start_angle, uint16_t sweep, SSD1306_COLOR color);
extern void ssd1306_DrawCircle(uint8_t par_x, uint8_t par_y, uint8_t par_r, SSD1306_COLOR color);
extern void ssd1306_FillCircle(uint8_t par_x, uint8_t par_y, uint8_t par_r, SSD1306_COLOR par_color);
 ...
 * @note RESET = 7Fh.
 */
extern void ssd1306_SetContrast(const uint8_t value);

/**
 * @brief Set Display ON/OFF.
 * @param[in] on 0 for OFF, any for ON.
 */
extern void ssd1306_SetDisplayOn(const uint8_t on);
 ...
 *          1: ON.
 */
extern uint8_t ssd1306_GetDisplayOn();
