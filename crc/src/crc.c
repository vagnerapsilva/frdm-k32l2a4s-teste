...
void teste_crc(void)
{
    ...
    display_init();
    display_clear();
    display_add_line("Data: %s", testData);
    ...
    display_add_line("CCITT: %04x", checksum16);
    if (checksum16 != checkCcittFalseCrc16)
    {
        display_add_line("Expected: %04x", checkCcittFalseCrc16);
    }
    ...
    display_add_line("MAXIM: %04x", checksum16);
    if (checksum16 != checkMaximCrc16)
    {
        display_add_line("Expected: %04x", checkMaximCrc16);
    }
    ...
    display_add_line("KERMIT: %04x", checksum16);
    if (checksum16 != checkKermitCrc16)
    {
        display_add_line("Expected: %04x", checkKermitCrc16);
    }
    ...
    display_add_line("CRC32: %08x", checksum32);
    if (checksum32 != checkCrc32)
    {
        display_add_line("Expected: %08x", checkCrc32);
    }
    ...
    display_add_line("POSIX: %08x", checksum32);
    if (checksum32 != checkPosixCrc32)
    {
        display_add_line("Expected: %08x", checkPosixCrc32);
    }
